...
import { SIDENAV_ITEMS } from '@/app/constantes';
import { SideNavItem } from '@/app/types';
import { Icon } from '@iconify/react';

const SideNav = () => {
  return (
    <div className="md:w-60 bg-[url('/images.jpg')] h-screen flex-1 fixed border-r border-zinc-200 hidden md:flex">
      <div className="flex flex-col space-y-6 w-full">
        <Link
          href="/"
          className="flex flex-row space-x-3 items-center justify-center md:justify-start md:px-6 border-b border-zinc-200 h-12 w-full"
        >
          <Image className='rounded-2xl' src="/logo.jpg" alt="Certificado" width={50} height={20} />
        </Link>
